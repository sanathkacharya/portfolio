...
- **Custom Domain**: Live at [www.sanathcloud.com](https://www.sanathcloud.com)
...
- **Notifications**: Sent to `contact@sanathcloud.com`
- **Auto-replies**: Sent to form submitters
- **No SMTP setup required**: Uses Resend API

## 🌐 Live Website

Visit the live portfolio: **[www.sanathcloud.com](https://www.sanathcloud.com)**
...
- **PR Reviewer**: ML-trained app for PR approval predictions - [pr-reviewer.sanathcloud.com](https://pr-reviewer.sanathcloud.com)
